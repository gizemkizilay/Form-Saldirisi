...
| Attribute           | Value                                 |
| :------------------ | :------------------------------------ |
| **Student**         | `Gizem Kızılay` (`2420191015`) |
| **Course**          | `secure-web`                       |
...
| **Documentation**      |  `80`  |     10     | Readme, architecture diagrams, installation instructions.               |
| **Repo Discipline**    |  `25`  |     10     | Proper directory structure, `.gitignore`, CI/CD, dependency management. |
